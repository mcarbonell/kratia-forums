...
export const mockUsers: User[] = [
  ...
  { 
    ...
    registrationDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(), // Registered 2 days ago
    karma: 0, 
    location: 'New York', 
    aboutMe: 'Learning the ropes.', 
    canVote: false, 
    isQuarantined: false, // Assuming sanction process makes them non-quarantined for now
    totalPostsByUser: 0, 
    totalReactionsReceived: 0, 
    totalPostsInThreadsStartedByUser: 0, 
    role: 'user', // Role remains 'user'
    status: 'under_sanction_process', // Initial status for testing
    sanctionEndDate: undefined 
  },
  { 
    id: 'user5', 
    username: 'SanctionedSam', 
    email: 'sam@example.com', 
    avatarUrl: 'https://picsum.photos/seed/sam/200/200', 
    registrationDate: '2023-02-01T10:00:00Z', 
    karma: 5, 
    location: 'Penalty Box', 
    aboutMe: 'Currently sanctioned.', 
    canVote: false, 
    isQuarantined: false, 
    totalPostsByUser: 0, 
    totalReactionsReceived: 0, 
