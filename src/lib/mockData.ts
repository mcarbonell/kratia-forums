...
export const mockUsers: User[] = [
  ...
  { id: 'user4', username: 'DianaNewbie', email: 'diana@example.com', registrationDate: '2023-03-20T14:30:00Z', karma: 0, location: 'New York', aboutMe: 'Just joined, excited to learn!', canVote: false, isQuarantined: true, totalPostsByUser: 0, totalReactionsReceived: 0, totalPostsInThreadsStartedByUser: 0 },
...
export const mockPosts: Post[] = [
  {
    id: 'post1', threadId: 'thread1_welcome', author: mockUsers.find(u=>u.id==='user1')!, content: 'This is the first post in the general discussion thread. Welcome everyone!', createdAt: '2023-05-01T10:00:00Z', reactions: {'👍': { userIds: ['user2'] } },
    poll: {
      id: 'poll1',
  ...
  { id: 'post2', threadId: 'thread1_welcome', author: mockUsers.find(u=>u.id==='user2')!, content: 'Thanks for the welcome, Alice! Glad to be here.', createdAt: '2023-05-01T10:05:00Z', reactions: {'😊': { userIds: ['user1'] } } },
  { id: 'post3', threadId: 'thread2_tech', author: mockUsers.find(u=>u.id==='user3')!, content: 'Let\'s talk about the future of technology. What are your predictions for AI in the next 5 years?', createdAt: '2023-05-02T11:00:00Z', reactions: {} },
  { id: 'post4', threadId: 'votation1_thread_sticky', author: mockUsers.find(u=>u.id==='user1')!, content: 'I propose we make "Introductions" a sticky thread. It helps new users find where to post first.', createdAt: '2023-06-01T09:00:00Z', reactions: {}},
  { id: 'post5', threadId: 'votation1_thread_sticky', author: mockUsers.find(u=>u.id==='user3')!, content: 'I agree with Alice. A sticky introductions thread would be very beneficial.', createdAt: '2023-06-01T09:15:00Z', reactions: {}},
];

export const mockThreads: Thread[] = [
  { id: 'thread1_welcome', forumId: 'forum1', title: 'General Discussion Welcome Thread', author: mockUsers.find(u=>u.id==='user1')!, createdAt: '2023-05-01T10:00:00Z', lastReplyAt: '2023-05-01T10:05:00Z', postCount: 2, isSticky: true },
  { id: 'thread2_tech', forumId: 'forum2', title: 'The Future of Technology', author: mockUsers.find(u=>u.id==='user3')!, createdAt: '2023-05-02T11:00:00Z', postCount: 1 },
  { id: 'thread3_books', forumId: 'forum1', title: 'Favorite Books of 2024', author: mockUsers.find(u=>u.id==='user2')!, createdAt: '2023-05-03T12:00:00Z', postCount: 0 },
];

export const mockAgoraThreads: Thread[] = [
   { id: 'votation1_thread_sticky', forumId: 'agora', title: '[VOTATION] Make "Introductions" thread sticky', author: mockUsers.find(u=>u.id==='user1')!, createdAt: '2023-06-01T09:00:00Z', postCount: 2, isLocked: false},
];
...
export const mockVotations: Votation[] = [
  {
    ...
    proposer: mockUsers.find(u=>u.id==='user1')!,
  ...
  },
  {
    ...
    proposer: mockUsers.find(u=>u.id==='user3')!,
